...
#
# PTMP:
# Temporary path to the parent directory of ${OPSROOT} for working and 
# output directories in development or testing.
# OPSROOT="${PTMP}/${envir}"
#
#-----------------------------------------------------------------------
#
PTMP="/temporary/path/to/parent/dir/of/OPSROOT/for/development"
#
#-----------------------------------------------------------------------
#
...
#
# model_ver:
# Version number of package in three digits; where package is the models
# directory name.
#
# OPSROOT:
# Operations root directory: e.g. /lfs/$FS/ops/$envir
# for development: OPSROOT=$PTMP/$envir
# COMROOT=$OPSROOT/com
...
# 
# KEEPDATA:
# Boolean variable used to specify whether or not the working directory
# should be kept upon successful job completion.
#
#-----------------------------------------------------------------------
#
envir_default="para"
...
# directory (EXECrrfs; this is set during experiment generation).
#
# WFLOW_XML_FN:
